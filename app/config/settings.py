...
try:
    from app.config.helpers import get_project_root, MetadataBase
except:
    from config.helpers import get_project_root, MetadataBase


custom_metadata = MetadataBase(
    title="API Template",
    description="This is a simple api template for projects",
    repository="https://github.com/abdurasuloff/fastapi-template",
    license_info={
        "name": "MIT",
        "url": "https://opensource.org/licenses/MIT",
    },
    contact={
        "name": "Abdurasulov Akbarjon",
        "url": "https://www.akbarjon.uz",
    },
    email="abdurasulovcodes@gmail.com",
    year="2024",
)
